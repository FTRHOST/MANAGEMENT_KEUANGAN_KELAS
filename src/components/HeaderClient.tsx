...
export default function HeaderClient({ isAuthenticated, settings }: HeaderClientProps) {
  ...
  return (
    <>
      <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-border-color px-4 md:px-6 py-4 bg-white rounded-xl shadow-sm">
